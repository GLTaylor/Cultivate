...
public struct JournalQuestionsAnswers: Equatable {
    ...
    public static let defaultQuestionsAnswers = JournalQuestionsAnswers(questionsAnswers: [
        ...
        .init(id: .init(), question: "What do you want your friends to ask you?", answer: .text("")),
        .init(id: .init(), question: "What's something you want to tell your tomorrow self?", answer: .text(""))
    ])
}
